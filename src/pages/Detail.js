                ...
                <section className='grid grid-cols-2 mt-5'>
                    ...
                    <div className=''>
                        ...
                        <div className='my-4 border-b-2 pb-10'>
                            <h1 className='text-2xl text-gray-800 font-bold text-left'>Auction</h1>
                            <h1 className='text-left font-semibold '>3/4 Kate Street, East Mackay QLD 4740</h1>
